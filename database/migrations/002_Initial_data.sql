...
VALUES
    (1,12345678,'Ingenieria Informatica','alumno'),
    (2,23456789,'Contador Publico','alumno'),
    (3,34567890,'Derecho','alumno'),
    (4,44444444,'MBA','alumno'),
    (5,55555555,'Maestria en Gestion Educativa','alumno'),
...
INSERT INTO reserva(id_reserva, nombre_sala, edificio, fecha, estado, id_turno)
VALUES
    (1,'M103','Mulling','2025-10-29','activa',1),
    (2,'B201','Ucu Business','2025-10-19','sin asistencia',3),
    (3,'C210','Edificio Central','2025-11-29','cancelada',2),
    (4,'M103','Mulling','2025-09-29','finalizada',4),
    (5,'M101','Mulling','2025-10-30','activa',2),
    (6,'B305','Ucu Business','2025-10-20','finalizada',4),
    (7,'B201','Ucu Business','2025-10-27','sin asistencia',5),
    (8,'C410','Edificio Central','2025-11-02','activa',6),
    (9,'C210','Edificio Central','2025-11-02','cancelada',7),
    (10,'C410','Edificio Central','2025-11-05','finalizada',8),
    (11,'SJ12','San Jose','2025-10-15','sin asistencia',9);
