...
const Reportes = () => {
    ...
    const dataRes = ReservasUtilizadasOCanceladas?.reservas_utilizadas_vs_canceladas_noAsistidas?.map(r => [r.porcentaje_utilizadas != null ? `${r.porcentaje_utilizadas}%` : '-', r.porcentaje_no_utilizadas != null ? `${r.porcentaje_no_utilizadas}%` : '-'])
    // -------------------------------
